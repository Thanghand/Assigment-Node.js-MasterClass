var UserTransformsModel = require('../../shared/transfomrations/UserTransformsModel');
var UserRepository = require('../../shared/repository/UserRepository');
...
ValidationUserLogic.prototype.validateNewAccount = function validateNewAccount(body, response) {
    var userEntity = this.UserTransformsModel.transformBodyToUserEntity(body);
